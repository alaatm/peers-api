...
namespace Mashkoor.Modules.Migrations
{
    ...
    partial class MashkoorContextModelSnapshot : ModelSnapshot
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Mashkoor.Modules.Customers.Domain.Customer", b =>
                {
                    b.Property<int>("Id")
                        .HasColumnType("int")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("Mashkoor.Modules.I18n.Domain.Language", b =>
                {
            ...
            modelBuilder.Entity("Mashkoor.Modules.Settings.Domain.Terms", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Mashkoor.Modules.Settings.Domain.TermsTranslation", b =>
                {
                    b.Property<int>("EntityId")
                        .HasColumnType("int")
                        .HasColumnName("entity_id");
            ...
            modelBuilder.Entity("Mashkoor.Modules.System.Domain.ClientAppInfo", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ComplexProperty<Dictionary<string, object>>("LatestVersion", "Mashkoor.Modules.System.Domain.ClientAppInfo.LatestVersion#ClientAppVersion", b1 =>
                        {
                            b1.IsRequired();
            ...
            modelBuilder.Entity("Mashkoor.Modules.Users.Domain.AppUser", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Mashkoor.Modules.Users.Domain.Device", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Mashkoor.Modules.Users.Domain.DeviceError", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Mashkoor.Modules.Users.Domain.Notification", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Mashkoor.Modules.Users.Domain.PushNotificationProblem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Mashkoor.Modules.Users.Domain.UserNotification", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Mashkoor.Modules.Users.Domain.UserStatusChange", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Mashkoor.Modules.Customers.Domain.Customer", b =>
                {
                    b.HasOne("Mashkoor.Modules.Users.Domain.AppUser", "User")
                        .WithOne()
                        .HasForeignKey("Mashkoor.Modules.Customers.Domain.Customer", "Id")
            ...
            modelBuilder.Entity("Mashkoor.Modules.Settings.Domain.PrivacyPolicyTranslation", b =>
                {
                    ...
                    b.HasOne("Mashkoor.Modules.I18n.Domain.Language", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Mashkoor.Modules.Settings.Domain.TermsTranslation", b =>
                {
                    b.HasOne("Mashkoor.Modules.Settings.Domain.Terms", "Entity")
                        .WithMany("Translations")
                        .HasForeignKey("EntityId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Mashkoor.Modules.Users.Domain.AppUser", b =>
                {
                    b.OwnsMany("Mashkoor.Modules.Users.Domain.AppUsageHistory", "AppUsage", b1 =>
                        {
                            b1.Property<int>("id")
                                .ValueGeneratedOnAdd()
                                .HasColumnType("int")
                    ...
                    b.OwnsMany("Mashkoor.Modules.Users.Domain.RefreshToken", "RefreshTokens", b1 =>
                        {
                            b1.Property<int>("id")
                                .ValueGeneratedOnAdd()
                                .HasColumnType("int")
            ...
            modelBuilder.Entity("Mashkoor.Modules.Users.Domain.UserNotification", b =>
                {
                    b.HasOne("Mashkoor.Modules.Users.Domain.Notification", "Notification")
                        .WithMany()
            ...
            modelBuilder.Entity("Mashkoor.Modules.Users.Domain.UserStatusChange", b =>
                {
                    b.HasOne("Mashkoor.Modules.Users.Domain.AppUser", "ChangedBy")
                        .WithMany()
                        .HasForeignKey("ChangedById")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("Mashkoor.Modules.Users.Domain.AppUser", null)
