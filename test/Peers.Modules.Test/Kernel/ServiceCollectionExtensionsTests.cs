...
public class ServiceCollectionExtensionsTests
{
    ...
    public void AddPeers_adds_all_required_services(string envName)
    {
        // Arrange
...
#pragma warning restore CS0618 // Type or member is obsolete
        ...
        var serviceProvider = serviceCollection
            ...
            .AddPeers(config, webHostEnvMoq.Object)
        ...
        var context = serviceProvider.GetRequiredService<PeersContext>();
    ...
    [Fact]
    public void AddPeers_with_explicit_db_config_adds_all_required_services()
    {
        // Arrange
        var config = new ConfigurationBuilder()
            .AddInMemoryCollection(new Dictionary<string, string>
        ...
        var serviceProvider = new ServiceCollection()
            ...
            .AddPeers(
                config,
                cfg => cfg.UseInMemoryDatabase(nameof(AddPeers_adds_all_required_services)),
