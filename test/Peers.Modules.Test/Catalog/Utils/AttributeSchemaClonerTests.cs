...
public sealed class AttributeSchemaClonerTests
{
    ...
    public void CopyFrom_Clones_AllKinds_DependentAndNonDependentEnums_WithTranslations()
    {
        ...
        source
            .DefineDependentLookupAttribute(
                parentKey: "brand",
                key: "device_model",
                isRequired: true,
                position: 1,
        ...
        source
            .AddAttributeOption("shade", "light", position: 1, parentOptionKey: "red")
            .UpsertTranslations(("en", "Light"));

        source
            .AddAttributeOption("shade", "dark", position: 2, parentOptionKey: "blue")
        ...
        Assert.NotNull(tDeviceModel.DependsOn);
        Assert.Equal("brand", tDeviceModel.DependsOn.Key);
        Assert.Same(tBrand, tDeviceModel.DependsOn);
        ...
        var red = tColor.Options.Single(o => o.Key == "red");
        var blue = tColor.Options.Single(o => o.Key == "blue");
        var green = tColor.Options.Single(o => o.Key == "green");
        ...
        var light = tShade.Options.Single(o => o.Key == "light");
        var dark = tShade.Options.Single(o => o.Key == "dark");
